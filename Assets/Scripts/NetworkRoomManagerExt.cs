...
{
    public Dictionary<int, PlayerController> players { get; } = new Dictionary<int, PlayerController>();

    public override bool OnRoomServerSceneLoadedForPlayer(NetworkConnection conn, GameObject roomPlayer, GameObject gamePlayer)
    {
        players.Add(roomPlayer.GetComponent<NetworkRoomPlayer>().index, gamePlayer.GetComponent<PlayerController>());
        return true;
    }
